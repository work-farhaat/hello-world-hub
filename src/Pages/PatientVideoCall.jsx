          ...
          <div className="text-center">
            ...
            <div className="w-64 h-64 md:w-96 md:h-96 bg-gray-700 rounded-2xl flex items-center justify-center mx-auto mb-6 shadow-2xl">
              <div className="text-center">
                ...
                <p className="text-white text-xl font-semibold">{activeCall.doctorName}</p>
                <p className="text-gray-400">{activeCall.specialization}</p>
              </div>
            </div>
            ...
            <div className="bg-gray-800 rounded-xl p-4 inline-block">
              <p className="text-white font-medium">Connected with {activeCall.doctorName}</p>
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-white rounded-2xl shadow-xl p-6 md:p-8">
          ...
          <p className="text-gray-500 mb-8">
            Your upcoming virtual appointments are listed below. Click "Join Video Call" to connect with your doctor.
          </p>
          ...
          {virtualAppointments.length === 0 ? (
            ...
            <div className="grid gap-4">
              {virtualAppointments.map((apt) => (
                <div
                  key={apt.id}
                  className="bg-gradient-to-r from-blue-50 to-indigo-50 border border-blue-200 rounded-xl p-5 hover:shadow-md transition"
                >
                  <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                    <div className="flex-1">
                      ...
                      <p className="text-gray-500 text-sm">{apt.specialization}</p>
